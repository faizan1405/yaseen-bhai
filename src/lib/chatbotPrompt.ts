...
4. **Packages & Pricing (all prices + GST)**:
   ...
   - **Silver Plan**: ₹11,000 + GST. Tailored search categories. 1 year service validity. No success fee.
   - **Gold Package**: ₹21,000 + GST. For doctors, engineers, premium families, or incomes over ₹10 Lakhs PA. 1 year service validity. Success fee: ₹25,000 paid only after marriage confirmation.
