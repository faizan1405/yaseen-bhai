    ...
    <>
      ...
      <main className="flex-grow">
        <div className="container font-sans" style={{ padding: '40px 0 80px 0' }}>
          <SectionHeading
            title={t('pkgPages.highTitle')}
            subtitle={t('pkgPages.highSubtitle')}
            scriptText={t('pkgPages.highScript')}
            as="h1"
          />
          ...
          <div style={{
            ...
            <div>
              <div style={{ marginBottom: '24px', display: 'flex', gap: '12px' }}>
                <input
                  type="text"
                  placeholder={t('pkgPages.highSearchPh')}
            ...
            <div className="card-theme-wrapper" style={{ padding: '24px', position: 'sticky', top: '100px', border: '2.5px solid var(--gold-accent)', boxShadow: 'var(--gold-glow-shadow)' }}>
              ...
              {isFormComplete && !isPackageActive && (
                <>
                  ...
                  <a
                    href={`https://wa.me/919170975535?text=${encodeURIComponent(t('premium.waPremium'))}`}
                    target="_blank"
